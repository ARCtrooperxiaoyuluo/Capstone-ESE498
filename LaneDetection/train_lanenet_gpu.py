...
from dataset_minicity_train import MinicityDataset
...
if __name__ == '__main__':
    ...
    num_workers = 1
    ckpt_epoch_interval = 30  # save a model checkpoint every X epochs
    ...
    train_set = MinicityDataset(data_dir, 'train')
    val_set = MinicityDataset(data_dir, 'val')
