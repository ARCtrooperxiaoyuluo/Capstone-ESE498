...
class LidarProcessor(Node):
    def __init__(self):
        ...
        self.angle_limits = {
            '250_290': (250, 290),  # For processing 250°–290° range (right side)
            '70_110': (70, 110)  # For processing 70°–110° range (left side)
        }
        ...
        try:
            for scan in self.lidar.iter_scans():
                ...
                for (_, angle, distance) in scan:
                    # Collect points for the 250°–290° range (right side)
                    ...
                    # Collect points for the 70°–110° range (left side)
                ...
                # Process yaw and distance for 250°–290° range (right side)
                if points_250_290:
                ...
                # Process yaw and distance for 70°–110° range (left side)
                if points_70_110:
    ...
    def publish_lidar_250_290_data(self):
        """Publishes the yaw and distance data for the 250°–290° range (right side)."""
        ...
        self.get_logger().info(f'Published yaw 250°-290°: {self.yaw_250_290:.2f}°, distance: {self.distance_250_290:.2f} mm')

    def publish_lidar_70_110_data(self):
        """Publishes the yaw and distance data for the 70°–110° range (left side)."""
        # Create and populate the Float32MultiArray message
        msg = Float32MultiArray()
        ...
        self.get_logger().info(f'Published yaw 70°-110°: {self.yaw_70_110:.2f}°, distance: {self.distance_70_110:.2f} mm')
